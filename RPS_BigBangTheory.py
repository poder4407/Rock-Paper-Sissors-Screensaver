...
pygame.display.set_caption("Protector de Pantalla: Piedra, Papel o Tijeras en big bang theory")
...
lagartija_img = pygame.image.load(resource_path("images/lagartija.png"))
spock_img = pygame.image.load(resource_path("images/spock.png"))
...
lagartija_img = pygame.transform.scale(lagartija_img, (50, 50))
spock_img = pygame.transform.scale(spock_img, (50, 50))
...
def reset_game():
    ...
    lagartija_obj = {
        "name": "lagartija",
        "image": lagartija_img,
        "pos": random_position(lagartija_img),
        "vel": random_velocity_constant(3)
    }
    spock_obj = {
        "name": "spock",
        "image": spock_img,
        "pos": random_position(spock_img),
        "vel": random_velocity_constant(3)
    }

    return [rock_obj, paper_obj, scissors_obj,lagartija_obj, spock_obj]
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == update_event:
            ...
            elif all(obj["name"] == "lagartija" for obj in objects):
                winning_type = "lagartija"
            elif all(obj["name"] == "spock" for obj in objects):
                winning_type = "spock"
            else:
                winning_type = None
            ...
            if winning_type is not None and winning_type != winner_state:
                if winning_type == "rock":
                    ...
                    counter_tijera += 1
                elif winning_type == "lagartija":
                    counter_lagartija += 1
                elif winning_type == "spock":
                    counter_spock += 1    
    ...
    for i in range(len(objects)):
        for j in range(i + 1, len(objects)):
            ...
            if rect_i.colliderect(rect_j):
                ...
                # ROCK gana a lagartija
                elif objects[i]["name"] == "rock" and objects[j]["name"] == "lagartija":
                    objects[j]["name"] = "rock"
                    objects[j]["image"] = rock_img
                elif objects[i]["name"] == "lagartija" and objects[j]["name"] == "rock":
                    objects[i]["name"] = "rock"
                    objects[i]["image"] = rock_img
                ...
                # SCISSORS gana lagartija    
                elif objects[i]["name"] == "scissors" and objects[j]["name"] == "lagartija":
                    objects[j]["name"] = "scissors"
                    objects[j]["image"] = scissors_img
                elif objects[i]["name"] == "lagartija" and objects[j]["name"] == "sissors":
                    objects[i]["name"] = "scissors"
                    objects[i]["image"] = scissors_img
                ...
                # PAPER gana a spock    
                elif objects[i]["name"] == "paper" and objects[j]["name"] == "spock":
                    objects[j]["name"] = "paper"
                    objects[j]["image"] = paper_img
                elif objects[i]["name"] == "spock" and objects[j]["name"] == "paper":
                    objects[i]["name"] = "paper"
                    objects[i]["image"] = paper_img


                # LAGARTIJA gana a paper
                elif objects[i]["name"] == "lagartija" and objects[j]["name"] == "paper":
                    objects[j]["name"] = "lagartija"
                    objects[j]["image"] = lagartija_img
                elif objects[i]["name"] == "paper" and objects[j]["name"] == "lagartija":
                    objects[i]["name"] = "lagartija"
                    objects[i]["image"] = lagartija_img
                # LAGARTIJA gana a spock    
                elif objects[i]["name"] == "lagartija" and objects[j]["name"] == "spock":
                    objects[j]["name"] = "lagartija"
                    objects[j]["image"] = lagartija_img
                elif objects[i]["name"] == "spock" and objects[j]["name"] == "lagartija":
                    objects[i]["name"] = "lagartija"
                    objects[i]["image"] = lagartija_img


                # SPOCK gana a rock
                elif objects[i]["name"] == "spock" and objects[j]["name"] == "rock":
                    objects[j]["name"] = "spock"
                    objects[j]["image"] = spock_img
                elif objects[i]["name"] == "rock" and objects[j]["name"] == "spock":
                    objects[i]["name"] = "spock"
                    objects[i]["image"] = spock_img
                # SPOCK gana a scissors
                elif objects[i]["name"] == "spock" and objects[j]["name"] == "scissors":
                    objects[j]["name"] = "spock"
                    objects[j]["image"] = spock_img
                elif objects[i]["name"] == "scissors" and objects[j]["name"] == "spock":
                    objects[i]["name"] = "spock"
                    objects[i]["image"] = spock_img
    ...
    text_lagartija = font.render("LAGARTIJA " + str(counter_lagartija), True, (255, 255, 255))
    text_spock = font.render("SPOCK " + str(counter_spock), True, (255, 255, 255))
    ...
    pos_text_lagartija = (width - text_lagartija.get_width() - margin, height - text_lagartija.get_height() - margin)
    pos_text_spock = (width/2 - text_spock.get_width() - margin/2, height - text_spock.get_height() - margin)

    screen.blit(text_piedra, pos_text_piedra)
    screen.blit(text_papel, pos_text_papel)
    screen.blit(text_tijera, pos_text_tijera)
    screen.blit(text_lagartija, pos_text_lagartija)
    screen.blit(text_spock, pos_text_spock)
